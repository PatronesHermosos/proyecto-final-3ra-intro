...
.banner_Basura .Basura{
    ...
    .banner_Basura .Basura:nth-child(2){
        left: -400px;
        top: -170px;
        display: block;
        transform: translate(500px, 400%);
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <!-- <li class="nav-item">
              ...
              <a class="nav-link" href=https://www.miteco.gob.es/es/ceneam/recursos/mini-portales-tematicos/reeducamar/videos-documentales.aspx> Artículos de Interés por © Ministerio para la Transición Ecológica y el Reto Demográfico/REEDUCAMAR </span></a></ul>
             </li>
            <!-- <li class="nav-item">
      ...
      <div id="scroll" class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <p><a class="btn bg-seco text-white" href=https://www.contaminacionx.com/contaminacion-agua/#¿Que_es_la_contaminacion_del_agua>Contaminación del agua (Estudio para LATAM) artículo por Sebastián Álvarez en ContaminaciónX, Año 2020.</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            ...
            <p class="lead">Las invito a conocer un poco más sobre las consecuencias de esta problemática accediendo a los siguientes links: 
              ...
              <p><a class="btn bg-seco text-white" href=https://www.youtube.com/watch?v=hEMLqrgEwbg> Reporte "Marine litter" por Surfrider Foundation Europe, Año 2011.</a></p>   
            ...
            <p><a class="btn bg-seco text-white" href=https://www.youtube.com/watch?v=KfDfl03-a-o> La Ruta del Plástico (Episodio Completo) por Explorer Investigation (National Geographic Latinoamérica), Año 2019.</a></p>  
          </div>
          <div class="col-md-5">
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2">
            ...
            <p class="lead"> "También hablamos de  las aves que se quedan enredadas en las artes de pesca y otros desechos plásticos; lo ingieren al confundirlo con alimento; y lo utilizan como material para hacer sus nidos al confundirlo con hojas, ramas y otros artículos naturales, lo que hiere y atrapa a los polluelos.
              ...
              <p class="lead">Fuente: <a class="btn bg-seco text-white" href=https://www.greenpeace.org/mexico/blog/2588/4-animales-que-sufren-por-la-contaminacion-plastica/> "4 animales que sufren por la contaminación plástica" artículo publicado por Daniela Albarrán en 'Greenpeace', Año 2019.</a></p>  
        ...
        <div class="row featurette">
          <div class="col-md-7">
            ...
            <h2 style="color: #5BC07B;">Ya, ¿Lo has visto? ¡Es realmente impresionante!</b></h2>
              ...
              <p class="lead">Fuente: <a class="btn bg-seco text-white" href=https://www.enestadocrudo.com/isla-basura/> "Isla de basura: dudas y respuestas" artículo publicado ‘En Estado Crudo’, Año 2019.</a></p> 
